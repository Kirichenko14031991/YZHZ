export function openRieInfo() {
    ...
    <ul>
        <li><a href="#" target="_blank">Соціальні послуги – Центри соціального захисту Хорватії</a></li>
        <li><a href="#" target="_blank">Допомога у працевлаштуванні – Агенція з працевлаштування Хорватії</a></li>
    </ul>

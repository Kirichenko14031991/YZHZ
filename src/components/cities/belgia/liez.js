export function openLiezInfo() {
    ...
    <ul>
        ...
        <li><a href="#" target="_blank">Соціальна допомога – OCMW Льєж</a></li>
    </ul>
    ...
    <ul>
        <li><a href="#" target="_blank">Матеріальна допомога – CPAS Льєж</a></li>
    ...
    <ul>
        ...
        <li><a href="#" target="_blank">Гуманітарна підтримка – Червоний Хрест</a></li>
    </ul>

    <h2>Освіта та інтеграція</h2>
    <ul>
        <li><a href="#" target="_blank">Мовні курси – Atlas Льєж</a></li>
